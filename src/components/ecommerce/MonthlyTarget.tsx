      ...
      <div className="px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6">
        ...
        <form className="max-w-md mx-auto">
          ...
          <div className="relative z-0 w-full mb-5 group">
            ...
            >
              <option>Arief</option>
              <option>Sheehan</option>
              <option>Reihan</option>
              <option>-</option>
            </select>
          </div>
          ...
          <div className="relative z-0 w-full mb-5 group">
            ...
            >
              <button
                type="button"
                className="inline-flex items-center justify-center w-6 h-6 me-2 
                 text-sm font-semibold text-gray-800 bg-gray-100 rounded-full 
                 dark:bg-gray-700 dark:text-gray-300 hover:bg-gray-200 
